...
static const char* friendlyName(const std::string& stem) {
    static const struct { const char* k; const char* n; } MAP[] = {
        {"abaddon","Abaddon"},{"alchemist","Alchemist"},{"NULL","NULL"},{"io","Io"},
        {"ancient_apparition","Ancient Apparition"},{"kez","Kez"},{"largo","Largo"},
        {"anti_mage","Anti-Mage"},{"antimage","Anti-Mage"}, {"timbersaw","Timbersaw"},
        ...
        {"mirana","Mirana"},{"monkey_king","Monkey King"},{"monkey_king1","Monkey King"},
        ...
        {"wraith_king","Wraith King"},{"zeus","Zeus"},{"zuus","Zeus"}, {"null_abaddon","NULL"},{"null_alchemist","NULL"},
...
int main(int argc, char* argv[]) {
    ...
    // ── .dat (бинарный, для рантайма) ──
    {
        ...
        for (const auto& e : entries) {
            uint16_t nameLen = static_cast<uint16_t>(e.display.size());
            out.write(reinterpret_cast<const char*>(&nameLen), 2);
            out.write(e.display.data(), nameLen);
