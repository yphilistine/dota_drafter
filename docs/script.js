var i18n = {
  ru: {
    ...
    feat1Desc: "CatBoost модель предсказывает вероятность победы для каждого возможного пика (AUC 0.6, Accuracy 0.6)",
  ...
  en: {
    ...
    feat1Desc: "CatBoost model predicts win probability for every possible pick (AUC 0.6, Accuracy 0.6)",
