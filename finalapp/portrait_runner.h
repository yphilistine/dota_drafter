...
// PNG (radiant/dire_hero_0..4, radiant/dire_pos_0..4) + report.txt с именем и
// score распознанного героя на каждый слот и с сырым OCR-текстом/позицией/score
// на каждый позиционный слот. dbPath — playerandlivestats.db (справочник heroes
// для имени). Возвращает false, если окно Dota 2 не найдено или кадр не
// захвачен (dir тогда не создаётся).
