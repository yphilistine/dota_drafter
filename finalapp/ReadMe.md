...
- **Кнопка [screenshot]** — рядом с заголовком панели драфта; сохраняет 10 регионов героев + 10 регионов позиций текущего кадра HUD в папку `screenshots\` — для диагностики, если распознавание драфта ошибается
...
screenshots/                        Регионы героев/позиций по кнопке [screenshot] (папка создаётся инсталлятором)
```
